...
<!-- badges: start -->
[![R build status](https://github.com/villegar/RhAMPseq/workflows/R-CMD-check/badge.svg)](https://github.com/villegar/RhAMPseq/actions)
`r badger::badge_devel("villegar/MetaPipe", "blue")`
`r badger::badge_codecov("villegar/RhAMPseq")`
<!-- badges: end -->
